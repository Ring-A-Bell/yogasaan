export function getDesc(poseName) {
    ...
    else if(poseName==="GalUkpGYVg34PfalkuTE")
    ...
    else if(poseName==="NdqzUSOSw4aSF5Spo9ZJ")
    ...
    else if(poseName==="R7G6tzbjRhmzDnRXTmr5")
    ...
    else if(poseName==="T7w6b8wlLMj8qzyUzdwZ")
    ...
    else if(poseName==="bsn0ppCqhVWuJZE5sQpB")
